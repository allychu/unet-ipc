"""
Finetune a pre-trained U-Net checkpoint
Used for U-Net that was pre-trained with IPC data
...
parser.add_argument('-c', '--checkpt_path', default="/Users/KayK/projects/bv-proj/unet-ipc-project/lightning_logs/pretrain_ds/checkpoints/epoch=0-step=188.ckpt")
parser.add_argument('-l', '--learning_rate', type=float, default=1e-4)
args = parser.parse_args()

data_dir = args.data_dir
checkpoint_path = args.checkpt_path
# IPC input shouldn't be used
# Since we want inherent IPC learned pre-training 
use_ipc = False 
